...
class ClientsController extends Controller
{
    ...
    public function searchClientsRequest(Request $request)
    {
        $keyword = $request->get('search');
        ...
        return Excel::download(new SearchClientsExport($clients) ,'clientes_filtrados.xlsx');
    }

    public function importClientsRequest(Request $request)
    {
